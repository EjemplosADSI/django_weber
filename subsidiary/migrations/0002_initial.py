...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            ...
            name='administrator',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='administered_subsidiaries', to='user_profile.userprofile', verbose_name='Administrador'),
        ),
        migrations.AddField(
            model_name='subsidiary',
            name='busine',
